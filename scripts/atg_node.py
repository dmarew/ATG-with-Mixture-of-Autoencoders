...
class AspectTransitionGraph:
    ...
    def reset_atg(self):
        ...
        self.autoencoder_mixture[self.aspect_count]['image'] = None
        self.autoencoder_mixture[self.aspect_count]['stat'] = np.array([0, 1])
        self.aspect_images = []
        self.atg = {}
...
def main(args):
    ...
    try:
        ...
        with open(result_folder_path + experiment_name + '/' +  experiment_name + '.pickle', 'wb') as handle:
